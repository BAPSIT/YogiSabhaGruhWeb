<%@ Page Title="" Language="C#" MasterPageFile="~/Master/YSGWeb.Master" AutoEventWireup="true" CodeBehind="Cancellation_datewise.aspx.cs" Inherits="YSGOpsWeb.Pages.Cancellation_datewise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="panel-heading">Cancellation Datewise</div>
            ...
            <div class="row">
             ...
             <div class="row">
                 ...
                 <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="1019px" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
                     <LocalReport ReportPath="Reports\Cancellation_datewise.rdlc">
                         <DataSources>
                 ...
                 <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:YogiSabhaGruhConnectionString %>" SelectCommand="RPT_BOOKING_CANCELLATION_DATE_WISE" SelectCommandType="StoredProcedure">
                     <SelectParameters>
